...
parser.add_argument('--sparsity_type', type=str, default='channel', choices=["channel", "weight"], help="Set sparsity type")
...
parser.add_argument('--run_id', type=str, default="05_uni", help="Set if different run id is necessary")
...
class AttackPGD(nn.Module):
    def __init__(self, basic_model, config):
        ...
        self.num_steps = 10  # config.num_steps
